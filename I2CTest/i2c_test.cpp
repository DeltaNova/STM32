...
void I2CRead3Bytes(uint8_t SlaveAddr, uint8_t NumberBytesToRead);  // Read 3+ Bytes
...
void I2CReadData(uint8_t NumberBytesToRead, uint8_t SlaveAddr)
{
    ...
    if (NumberBytesToRead == 1){
        ...
        I2CRead3Bytes(SlaveAddr, NumberBytesToRead);
    }
}
...
void I2CRead3Bytes(uint8_t SlaveAddr, uint8_t NumberBytesToRead){
